CREATE FUNCTION `insert_variable_product_fast_api`(_sku MEDIUMTEXT, _ten MEDIUMTEXT, _slug TEXT, _moTa TEXT, _moTaNgan LONGTEXT, _gia DOUBLE, _sale_price DOUBLE,
...
_idCategory TEXT, _listUrlImage MEDIUMTEXT, _list_image_meta LONGTEXT, _lstTagId TEXT,
_jsonAttribute LONGTEXT,
_default_attributes TINYTEXT, _post_status TINYTEXT,
...
BEGIN
	...
	_idCategory, 'variable', _listUrlImage, _list_image_meta, _lstTagId,
	0, _post_status,
	_weight, _height, _width, _length);
    
    INSERT INTO `wp_postmeta` (`post_id`,   `meta_key`,      `meta_value`)
	VALUES                     (@idProduct, '_product_attributes', _jsonAttribute);
    
    INSERT INTO `wp_postmeta` (`post_id`,   `meta_key`,      `meta_value`)
	VALUES                     (@idProduct, '_default_attributes', _default_attributes);
