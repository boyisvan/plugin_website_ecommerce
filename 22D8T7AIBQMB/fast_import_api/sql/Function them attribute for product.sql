CREATE FUNCTION `insert_attribute_for_product_fast_api`(_id_product BIGINT(20), _label TINYTEXT, _slug TINYTEXT,
...
BEGIN
    ...
    iterator:
		...
		SET @term_slug = _value2;-- slugify_fast_api(_value); => tính bên php cho thống nhất thuật toán
